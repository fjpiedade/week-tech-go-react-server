...
import (
	...
	"github.com/fjpiedade/week-tech-go-react-server/internal/store/pgstore"
		...
		r.Route("/rooms", func(r chi.Router) {
			...
			r.Route("/{room_id}/messages", func(r chi.Router) {
				...
				r.Route("/{message_id}", func(r chi.Router) {
					...
					r.Delete("/react", a.handleRemoveFromMessage)
...
func (h apiHandler) notifyClients(msg Message) {
	...
	for conn, cancel := range subscribers {
		if err := conn.WriteJSON(msg); err != nil {
			slog.Error("failed to send message to subscribers", "error", err)
			cancel()
		}
	}
}
...
func (h apiHandler) handleSubscribe(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Error(w, "something went wrong - server internal error!", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleRemoveFromMessage(w http.ResponseWriter, r *http.Request)     {}
